...
export default function HomeSection() {
    ...
    return (
        <section id="home" className="flex justify-center items-center bg-[url('/assets/bghome.webp')] bg-cover lg:col-span-2 animate-fade-up animate-once animate-duration-300 animate-ease-in-out shadow-lg">
