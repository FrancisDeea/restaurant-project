...
export default function Footer() {
    ...
    return (
        <header className="bg-dark text-light text-sm flex flex-col justify-evenly items-center min-h-min mb-4 p-2 max-w-[1268px] w-[calc(100%-32px)] m-auto rounded-[10px] lg:flex-row">
